...
%\begin{figure}[H]
%    \caption{\textbf{Tables de la base de données }}
%    \label{UML_bdd}
%    \centering
%    \includegraphics[angle=90,height=0.9\textheight]{UML_diagrammes/diag_relation.png}
%\end{figure}
...
\begin{figure}[H]
    \label{UML_classes}
    \centering
    \includegraphics[angle=90,height=0.9\textheight]{UML_diagrammes/diagramme_classe.png}
\end{figure}
